...
const SCOPE_OPTIONS = [
  { value: "all", label: "APES as a whole" },
...
export default function ApesMiniSectionPage() {
  ...
  async function generateSection() {
    ...
    try {
      const r = await fetch("/api/mini-section", {
        ...
        body: JSON.stringify({ scope, subject: "apes" }),
      });
        ...
        >
          ...
          >
            <div>
              ...
              >
                Take a 24-minute APES drill with 13 multiple-choice questions
