...
const SCOPE_OPTIONS = [
  { value: "all", label: "AP Micro as a whole" },
...
export default function MicroMiniSectionPage() {
  ...
  async function generateSection() {
    ...
    try {
      const r = await fetch("/api/mini-section", {
        ...
        body: JSON.stringify({ scope, subject: "micro" }),
      });
        ...
        >
          ...
          >
            <div>
              ...
              >
                Take a 24-minute AP Micro drill with 13 multiple-choice questions
