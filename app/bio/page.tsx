  ...
  return (
    <main style={{ padding: "48px 24px", fontFamily: "system-ui", backgroundColor: "#000", color: "#fff", minHeight: "100vh", maxWidth: 1100, margin: "0 auto" }}>
      ...
      <header style={{ marginBottom: 28 }}>
        ...
        <h1 style={{ fontSize: 46, margin: "10px 0", fontWeight: 900 }}>AP Biology</h1>
        <p style={{ color: "#e5e5e5", maxWidth: 780, lineHeight: 1.55, fontSize: 18 }}>
          Practice AP Biology with AI-generated MCQs, FRQs, and timed mini sections.
        </p>
      </header>

      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 16 }}>
        <ToolCard title="Practice MCQs" desc="Generate 5 AP Biology MCQs by unit." href="/bio/practice" />
        <ToolCard title="FRQ Studio" desc="Generate and grade AP Biology FRQs." href="/bio/frq" />
        <ToolCard title="Timed Mini Section" desc="Take a timed AP Bio drill with 13 MCQs and 2 FRQs." href="/bio/mini-section" />
      </div>
    </main>
  );
}
